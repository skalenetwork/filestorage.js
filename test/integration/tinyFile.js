...
let directoryPath = '/home/evgeniyzh/tinyFile/tinyFile1.txt'
...
async function upload(){
    ...
    for (let i = 642; i < 100000 ; ++i) {
        let directoryPath = '/home/evgeniyzh/tinyFile/tinyFile'+i+'.txt';
        var content;
        var contentPath;
        // First I want to read the file
        content = await fs.readFileSync(directoryPath)
        console.log(content);   // Put all of the code here (not the best solution)
        contentPath = await filestorage.uploadFile(address,'tinyFile'+i+'.txt', content,  pk);
