...
module.exports = class MetamaskStub {
    ...
    async initialize(driver, password, seedPhrase) {
        ...
        await driver.wait(until.elementLocated(By.xpath("//*[contains(text(), 'Continue')]")), 10000);
        await driver.findElement(By.xpath("//*[contains(text(), 'Continue')]")).click();
        await driver.wait(until.elementLocated(By.xpath("//*[contains(text(), 'Import with seed phrase')]")), 10000);
        await driver.findElement(By.xpath("//*[contains(text(), 'Import with seed phrase')]")).click();
        ...
        await driver.wait(until.elementIsEnabled(element), 100000);
        await element.click();
        await driver.wait(until.elementLocated(By.xpath("//div[@class='first-time-flow__markdown']")), 10000);
    ...
    async addEndpoint(driver, endpoint) {
        await driver.get("chrome-extension://" + this.metamaskId + "/home.html");
        await driver.wait(until.elementLocated(By.xpath("//div[@class='app-header__network-component-wrapper']")), 10000);
        await driver.findElement(By.xpath("//div[@class='app-header__network-component-wrapper']")).click();
    ...
    async addAccount(driver, privateKey) {
        await driver.get("chrome-extension://" + this.metamaskId + "/home.html");
        await driver.wait(until.elementLocated(By.xpath("//div[@class='identicon']")), 10000);
