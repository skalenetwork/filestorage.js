 ...
 * along with this program.  If not, see <https://www.gnu.org/licenses/>.
 */
const n=r(59),i=r(344),o=r(126),a=i[n.FILESTORAGE_CONTRACTNAME].abi,s=i[n.FILESTORAGE_CONTRACTNAME].address;t.exports=class{constructor(t){this.web3=t,this.contract=new t.eth.Contract(a,s)}async startUpload(t,e,r,i=""){let a=this.contract.methods.startUpload(e,r);return await o.sendTransactionToContract(this.web3,t,i,a,n.STANDARD_GAS)}async uploadChunk(t,e,r,i,a=""){let s=this.contract.methods.uploadChunk(e,r,i);return await o.sendTransactionToContract(this.web3,t,a,s,n.WRITING_GAS)}async deleteFile(t,e,r=""){let i=this.contract.methods.deleteFile(e);return await o.sendTransactionToContract(this.web3,t,r,i,n.STANDARD_GAS)}async finishUpload(t,e,r=""){let i=this.contract.methods.finishUpload(e);return await o.sendTransactionToContract(this.web3,t,r,i,n.STANDARD_GAS)}async readChunk(t,e,r){return await this.contract.methods.readChunk(t,e,r).call()}async getFileStatus(t){return await this.contract.methods.getFileStatus(t).call()}async getFileSize(t){return await this.contract.methods.getFileSize(t).call()}async createDirectory(t,e,r=""){let i=this.contract.methods.createDir(e);return await o.sendTransactionToContract(this.web3,t,r,i,n.STANDARD_GAS)}async deleteDirectory(t,e,r=""){let i=this.contract.methods.deleteDir(e);return await o.sendTransactionToContract(this.web3,t,r,i,n.STANDARD_GAS)}async listDirectory(t){return await this.contract.methods.listDir(t).call()}}},function(t){t.exports=JSON.parse('{"FileStorage.sol:FileStorage":{"abi":[{"constant":false,"inputs":[{"name":"directoryPath","type":"string"}],"name":"createDir","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"directoryPath","type":"string"}],"name":"deleteDir","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"filePath","type":"string"},{"name":"fileSize","type":"uint256"}],"name":"startUpload","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"filePath","type":"string"},{"name":"position","type":"uint256"},{"name":"data","type":"bytes"}],"name":"uploadChunk","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"filePath","type":"string"}],"name":"finishUpload","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"filePath","type":"string"}],"name":"deleteFile","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"name":"storagePath","type":"string"},{"name":"position","type":"uint256"},{"name":"length","type":"uint256"}],"name":"readChunk","outputs":[{"name":"out","type":"bytes32[32768]"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"storagePath","type":"string"}],"name":"listDir","outputs":[{"components":[{"name":"name","type":"string"},{"name":"isFile","type":"bool"},{"name":"size","type":"uint256"},{"name":"status","type":"int256"},{"name":"isChunkUploaded","type":"bool[]"}],"name":"","type":"tuple[]"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"storagePath","type":"string"}],"name":"getFileStatus","outputs":[{"name":"","type":"int256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"storagePath","type":"string"}],"name":"getFileSize","outputs":[{"name":"fileSize","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"}],"address":"0x69362535ec535F0643cBf62D16aDeDCAf32Ee6F7"}}')},function(t,e,r){t.exports=(()=>{"use strict";let t,e,r="https:"==location.protocol||"localhost"==location.hostname,n={createWriteStream:function(i,o,a){Number.isFinite(o)&&([a,o]=[o,a]);let s,u=new MessageChannel;return new WritableStream({start:o=>(()=>new Promise((o,c)=>{if(u.port1.onmessage=t=>{if(t.data.download){o(),r||s.close();let e=document.createElement("a"),n=new MouseEvent("click");e.href=t.data.download,e.dispatchEvent(n)}},r&&!t&&((t=document.createElement("iframe")).src=n.mitm,t.hidden=!0,document.body.appendChild(t)),r&&!e){let r;t.addEventListener("load",r=n=>{e=!0,t.removeEventListener("load",r),t.contentWindow.postMessage({filename:i,size:a},"*",[u.port2])})}if(r&&e&&t.contentWindow.postMessage({filename:i,size:a},"*",[u.port2]),!r){s=window.open(n.mitm,Math.random());let t=e=>{e.source===s&&(s.postMessage({filename:i,size:a},"*",[u.port2]),removeEventListener("message",t))};addEventListener("message",t)}}))(),write(t){u.port1.postMessage(t)},close(){u.port1.postMessage("end"),console.log("All data successfully read!")},abort(t){u.port1.postMessage("abort")}},o)},supported:!1,version:{full:"1.0.0",major:1,minor:0,dot:0}};n.mitm="https://jimmywarting.github.io/StreamSaver.js/mitm.html?version="+n.version.full;try{n.supported="serviceWorker"in navigator&&!!new ReadableStream&&!!new WritableStream}catch(t){}return n})()}]);