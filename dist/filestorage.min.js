 ...
 */
const n=r(59),i=r(341),o=r(342),a=/^(0x)?[0-9a-f]{64}$/i,s={ensureStartsWith0x:t=>!(t.length<2)&&("0"===t[0]&&"x"===t[1]),addBytesSymbol(t){return this.ensureStartsWith0x(t)?t:"0x"+t},rmBytesSymbol(t){return this.ensureStartsWith0x(t)?t.slice(2):t},bufferToHex:t=>Array.prototype.map.call(new Uint8Array(t),t=>("00"+t.toString(16)).slice(-2)).join(""),getBasename:t=>/^(?:\/?|)(?:[\s\S]*?)((?:\.{1,2}|[^\/]+?|)(?:\.[^.\/]*|))(?:[\/]*)$/.exec(t)[1],concatBytes32Array(t,e){return t.map(t=>this.rmBytesSymbol(t)).join("").slice(0,e)},validatePrivateKey(t){if(!a.test(t))throw new i(n.errorMessages.INVALID_PRIVATEKEY)},async signAndSendTransaction(t,e,r,o,a){let s=o.encodeABI(),u=o._parent._address,c=t.eth.accounts.privateKeyToAccount(r).address;if(e!==c&&e!==this.rmBytesSymbol(c))throw new i(n.errorMessages.INVALID_KEYPAIR);let f={from:e,data:s,gas:a,to:u,nonce:await t.eth.getTransactionCount(e),chainId:await t.eth.getChainId()},h=await t.eth.accounts.signTransaction(f,r);return"uploadChunk"!==o._method.name&&console.log("DATA >>>",o._method.name,">>>",h.rawTransaction),await t.eth.sendSignedTransaction(h.rawTransaction)},async sendTransaction(t,e,r,n){let i=await t.eth.getTransactionCount(e);return await r.send({from:e,gas:n,nonce:i})},async sendTransactionToContract(t,e,r,i,a){let u;try{return"string"==typeof r&&r.length>0?(this.ensureStartsWith0x(r)||(r="0x"+r),s.validatePrivateKey(r),u=await s.signAndSendTransaction(t,e,r,i,a)):u=await s.sendTransaction(t,e,i,a),"uploadChunk"!==i._method.name?console.log("OK: ",i._method.name,i.arguments,">>>",u):console.log("OK: ",i._method.name,i.arguments[0],">>>",u),u}catch(t){if("uploadChunk"!==i._method.name?console.log("ERROR: ",i._method.name,i.arguments,">>>",t):console.log("ERROR: ",i._method.name,i.arguments[0],">>>",t),t.message.includes(n.errorMessages.REVERTED_TRANSACTION)){let e=t.message.substr(n.errorMessages.REVERTED_TRANSACTION.length),r=JSON.parse(e).revertReason;throw new o(r||n.errorMessages.FAILED_TRANSACTION)}throw t}}};t.exports=s},function(t,e,r){(function(e){
/**
 * @license
 * SKALE Filestorage-js
 * Copyright (C) 2019-Present SKALE Labs
 ...
 * along with this program.  If not, see <https://www.gnu.org/licenses/>.
 */
t.exports=class extends Error{constructor(t){super(t),this.name=this.constructor.name,Error.captureStackTrace(this,this.constructor)}}},function(t,e){
/**
 * @license
 * SKALE Filestorage-js
 * Copyright (C) 2019-Present SKALE Labs
 ...
 * along with this program.  If not, see <https://www.gnu.org/licenses/>.
 */
t.exports=class extends Error{constructor(t){super(t),this.name=this.constructor.name,Error.captureStackTrace(this,this.constructor)}}},function(t,e,r){
/**
 * @license
 * SKALE Filestorage-js
 * Copyright (C) 2019-Present SKALE Labs
 ...
 * along with this program.  If not, see <https://www.gnu.org/licenses/>.
 */
const n=r(59),i=r(344),o=r(126),a=i[n.FILESTORAGE_CONTRACTNAME].abi,s=i[n.FILESTORAGE_CONTRACTNAME].address;t.exports=class{constructor(t){this.web3=t,this.contract=new t.eth.Contract(a,s)}async startUpload(t,e,r,i=""){let a=this.contract.methods.startUpload(e,r);return await o.sendTransactionToContract(this.web3,t,i,a,n.STANDARD_GAS)}async uploadChunk(t,e,r,i,a=""){let s=this.contract.methods.uploadChunk(e,r,i);return await o.sendTransactionToContract(this.web3,t,a,s,n.WRITING_GAS)}async deleteFile(t,e,r=""){let i=this.contract.methods.deleteFile(e);return await o.sendTransactionToContract(this.web3,t,r,i,n.STANDARD_GAS)}async finishUpload(t,e,r=""){let i=this.contract.methods.finishUpload(e);return await o.sendTransactionToContract(this.web3,t,r,i,n.STANDARD_GAS)}async readChunk(t,e,r){return await this.contract.methods.readChunk(t,e,r).call()}async getFileStatus(t){return await this.contract.methods.getFileStatus(t).call()}async getFileSize(t){return await this.contract.methods.getFileSize(t).call()}async createDirectory(t,e,r=""){let i=this.contract.methods.createDirectory(e);return await o.sendTransactionToContract(this.web3,t,r,i,n.STANDARD_GAS)}async deleteDirectory(t,e,r=""){let i=this.contract.methods.deleteDirectory(e);return await o.sendTransactionToContract(this.web3,t,r,i,n.STANDARD_GAS)}async listDirectory(t){return await this.contract.methods.listDirectory(t).call()}}},function(t){t.exports=JSON.parse('{"FileStorage.sol:FileStorage":{"abi":[{"constant":false,"inputs":[{"internalType":"address","name":"userAddress","type":"address"},{"internalType":"uint256","name":"reservedSpace","type":"uint256"}],"name":"reserveSpace","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"internalType":"string","name":"directoryPath","type":"string"}],"name":"createDirectory","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"internalType":"string","name":"directoryPath","type":"string"}],"name":"deleteDirectory","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"internalType":"string","name":"filePath","type":"string"},{"internalType":"uint256","name":"fileSize","type":"uint256"}],"name":"startUpload","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"internalType":"string","name":"filePath","type":"string"},{"internalType":"uint256","name":"position","type":"uint256"},{"internalType":"bytes","name":"data","type":"bytes"}],"name":"uploadChunk","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"internalType":"string","name":"filePath","type":"string"}],"name":"finishUpload","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"internalType":"string","name":"filePath","type":"string"}],"name":"deleteFile","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"internalType":"string","name":"storagePath","type":"string"},{"internalType":"uint256","name":"position","type":"uint256"},{"internalType":"uint256","name":"length","type":"uint256"}],"name":"readChunk","outputs":[{"internalType":"bytes32[32768]","name":"chunk","type":"bytes32[32768]"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"internalType":"string","name":"storagePath","type":"string"}],"name":"listDirectory","outputs":[{"components":[{"internalType":"string","name":"name","type":"string"},{"internalType":"bool","name":"isFile","type":"bool"},{"internalType":"uint256","name":"size","type":"uint256"},{"internalType":"enum FileStorage.FileStatus","name":"status","type":"uint8"},{"internalType":"bool[]","name":"isChunkUploaded","type":"bool[]"}],"internalType":"struct FileStorage.ContentInfo[]","name":"","type":"tuple[]"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"internalType":"string","name":"storagePath","type":"string"}],"name":"getFileStatus","outputs":[{"internalType":"enum FileStorage.FileStatus","name":"","type":"uint8"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"internalType":"string","name":"storagePath","type":"string"}],"name":"getFileSize","outputs":[{"internalType":"uint256","name":"fileSize","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"getStorageSpace","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"}],"address":"0x69362535ec535F0643cBf62D16aDeDCAf32Ee6F7"}}')},function(t,e,r){t.exports=(()=>{"use strict";let t,e,r="https:"==location.protocol||"localhost"==location.hostname,n={createWriteStream:function(i,o,a){Number.isFinite(o)&&([a,o]=[o,a]);let s,u=new MessageChannel;return new WritableStream({start:o=>(()=>new Promise((o,c)=>{if(u.port1.onmessage=t=>{if(t.data.download){o(),r||s.close();let e=document.createElement("a"),n=new MouseEvent("click");e.href=t.data.download,e.dispatchEvent(n)}},r&&!t&&((t=document.createElement("iframe")).src=n.mitm,t.hidden=!0,document.body.appendChild(t)),r&&!e){let r;t.addEventListener("load",r=n=>{e=!0,t.removeEventListener("load",r),t.contentWindow.postMessage({filename:i,size:a},"*",[u.port2])})}if(r&&e&&t.contentWindow.postMessage({filename:i,size:a},"*",[u.port2]),!r){s=window.open(n.mitm,Math.random());let t=e=>{e.source===s&&(s.postMessage({filename:i,size:a},"*",[u.port2]),removeEventListener("message",t))};addEventListener("message",t)}}))(),write(t){u.port1.postMessage(t)},close(){u.port1.postMessage("end"),console.log("All data successfully read!")},abort(t){u.port1.postMessage("abort")}},o)},supported:!1,version:{full:"1.0.0",major:1,minor:0,dot:0}};n.mitm="https://jimmywarting.github.io/StreamSaver.js/mitm.html?version="+n.version.full;try{n.supported="serviceWorker"in navigator&&!!new ReadableStream&&!!new WritableStream}catch(t){}return n})()}]);